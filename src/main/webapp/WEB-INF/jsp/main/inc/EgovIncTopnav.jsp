...
<ul>
    ...
    <li><a href="#LINK" onclick="javascript:fn_main_headPageAction('42','cop/bbs/selectBoardList.do?bbsId=BBSMSTR_AAAAAAAAAAAA')" >알림마당</a></li>
    <%
       LoginVO loginVO = (LoginVO)session.getAttribute("LoginVO"); 
       if(loginVO != null){ 
    %>
    <li><a href="#LINK" onclick="javascript:fn_main_headPageAction('51','cop/bbs/selectBoardList.do?bbsId=BBSMSTR_AAAAAAAAAAAA')" >사이트관리(관리자)</a></li>
    <%
       }
    %>
</ul>
